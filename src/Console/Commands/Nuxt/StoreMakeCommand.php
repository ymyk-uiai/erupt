...
class StoreMakeCommand extends BaseCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'erupt:store {name} {--model=}';
     ...
     * @var string
     */
    protected $description = 'make a nuxt store class';
    ...
    protected function getStub()
    {
        ...
        $name = "store." . lcfirst($this->argument("name"));
    ...
    protected function updatePath($path)
    {
        ...
        return $this->laravel->basePath("client/store/$model/$path");
    }
